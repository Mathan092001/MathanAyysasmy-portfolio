import './style.css';
import { FaHtml5, FaCss3Alt, FaReact, FaBootstrap, FaGithub, FaNodeJs } from "react-icons/fa";
...
import { SiRemix, SiMongodb  } from "react-icons/si";
...
export default function Skills() {
    ...
    useEffect(() => {
        ...
        scroll.reveal('.skillset-4', {origin: 'bottom', delay: 700})
    }, [])

    return ( 
        <section id="skills" className="skill-section w-[100vw] md:gap-10 gap-5 md:h-[130vh] h-[100%] bg-slate-950 text-white flex flex-col justify-center items-center p-8 select-none"> 
            ...
            <div className="skillset-3 flex flex-col justify-center items-center ">
                <div className="flex flex-col justify-center items-center text-gray-300">
                   <h2 className="md:text-[1.5vw] font-[700] text-gray-500 text-[5vw]">Backend</h2>
                </div>
                <div className=" md:max-w-[60vw] max-w-[90vw]">
                    <ul className="tag-list md:text-[8vw] text-[16vw] md:gap-[1.5rem] gap-2 flex">
                        <div className='flex flex-col gap-2 justify-center items-center'>
                           <li className="text-green-500 md:px-3 md:py-2 px-2 py-1"><FaNodeJs className='hover:scale-110 duration-500 ease-in-out'/></li>
                           <h2 className='md:text-[1vw] text-[3vw] font-semibold text-gray-400'>Node JS</h2>
                        </div>
                        <div className='flex flex-col gap-2 justify-center items-center'>
                           <li className="text-blue-500 md:px-3 md:py-2 px-2 py-1"><BiLogoPostgresql className='md:w-[8vw] w-[16vw] hover:scale-110 duration-500 ease-in-out'/></li>
                           <h2 className='md:text-[1vw] text-[3vw] font-semibold text-gray-400'>PostgreSQL</h2>
                        </div>
                        <div className='flex flex-col gap-2 justify-center items-center'>
                           <li className="text-gray-200 md:px-3 md:py-2 px-2 py-1"><SiRemix className='md:w-[8vw] w-[16vw] hover:scale-110 duration-500 ease-in-out '/></li>
                           <h2 className='md:text-[1vw] text-[3vw] font-semibold text-gray-400'>Remix</h2>
                        </div>
                            <div className='flex flex-col gap-2 justify-center items-center'>
                            <li className="text-green-700 md:px-3 md:py-2 px-2 py-1"><SiMongodb className='md:w-[8vw] w-[16vw] hover:scale-110 duration-500 ease-in-out '/></li>
                            <h2 className='md:text-[1vw] text-[3vw] font-semibold text-gray-400'>MongoDB</h2>
                            </div>
                    </ul>
                </div>
            </div>
            <div className="skillset-4 flex flex-col justify-center items-center ">
                <div className="flex flex-col justify-center items-center text-gray-300">
