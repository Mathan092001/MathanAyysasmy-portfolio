...
import Project5 from '../assets/My-Portfolio.png'
...
export default function Project() {
    ...
    useEffect(() => {
        ...
        scroll.reveal('.mywork-text', {origin: 'bottom', delay: 400})
        scroll.reveal('.projects-1', {origin: 'bottom', delay: 500})
        scroll.reveal('.projects-2', {origin: 'bottom', delay: 600})
        scroll.reveal('.projects-3', {origin: 'bottom', delay: 700})
    }, [])

    return (
        <section id="projects" className="project-section w-[100vw] md:h-[270vh] bg-slate-950 text-white flex flex-col justify-center items-center md:gap-20 gap-10 relative bottom-0 p-8 "> 
            <div className="main-box-top flex flex-col justify-center items-center md:gap-20 md:mt-[-6vw] gap-10">
                <div className=" flex flex-col justify-center items-center text-gray-300">
                    <h2 className="mywork-text border-dashed border-b-2 border-blue-800 px-5 bg-black md:text-[1.8vw] text-[6vw]">My Work</h2>
                </div>
                <div className='projects-1 md:flex md:gap-20 flex-wrap flex gap-10 justify-center items-center'>
                ...
                <div className='projects-2 md:flex md:gap-20 flex-wrap flex gap-10 justify-center items-center'>
                    <div className='box flex flex-col md:gap-4 gap-2 items-center bg-gray-800 md:w-[30vw] w-[90vw] md:h-auto md:p-6 p-3 rounded-t-[1rem]'>
                ...
                <div className='projects-3 md:flex md:gap-20 flex-wrap flex gap-10 justify-center items-center'>
                    <div className='box flex flex-col md:gap-4 gap-2 items-center bg-gray-800 md:w-[30vw] w-[90vw] md:h-auto md:p-6 p-3 rounded-t-[1rem]'>
                        <div className='bg-blue-700 hover:bg-black duration-[0.9s] md:w-[27vw] md:h-[30vh] w-[80vw] h-[25vh] rounded-t-[1rem] relative flex justify-center items-end overflow-hidden'>
                            <img src={Project5} className='md:w-[23vw] w-[70vw] rounded-t-[1rem] absolute hover:scale-[1.4] duration-[0.9s] ease-in-out' alt="" />
                        </div>
                        <div className='flex justify-between items-center w-full px-1'>
                            <h1 className='border border-[2px] bg-black duration-[0.6s] select-none md:rounded-t-[0.5vw] rounded-t-[1vw] border-b-blue-600 border-t-0 border-l-0 border-r-0 md:text-[1.2vw] text-[3.5vw] px-5 text-gray-400'>My Portfolio Website</h1>
                            <div className='flex md:gap-3 gap-2 text-gray-400'>
                                <i className='arrow p-1 bg-gray-400 text-black md:text-[1.5vw] text-[5vw] rounded-full cursor-pointer hover:bg-black hover:text-gray-300 '><a href='#' rel="noopener noreferrer"><FaArrowUp /></a></i>
                                <i className='p-1 bg-black rounded-full cursor-pointer md:text-[1.5vw] text-[5vw] hover:bg-gray-400 hover:text-black duration-[0.2s] ease-in-out hover:scale-[1.1]'><a href='https://github.com/Mathan092001/MathanAyysasmy-portfolio' target='_blank' rel="noopener noreferrer"><FiGithub /></a></i>
                            </div>
                        </div>
                    </div>
                </div>
