...
export default function Footer() {
    ...
    return(            
        <footer className="footer w-full md:h-[25vh] h-[20vh] bg-black text-gray-300 flex justify-center items-center md:p-8 p-3 select-none">
            ...
            <div className="flex flex-col justify-start items-start md:gap-10 gap-9 opacity-90">
                <div className='flex flex-col text-gray-500'>
                <div className='flex md:gap-2 gap-1 md:text-[2vw] text-[4vw] '>
                  <h1 >By:</h1>
            ...
            <div className="flex flex-col md:gap-12 gap-10 justify-end items-end text-[6vw] md:text-[2vw] text-gray-500">
                ...
                <tbody className='flex gap-1 md:gap-4 items-center '>
                    ...
                    <hr className='border border-blue-800 md:h-[2.5vh] h-[4vw]'/>
                    ...
                    <hr className='border border-blue-800 md:h-[2.5vh] h-[4vw]'/>
                    <a href="mailto:mathanayysamy@gmail.com?subject=Hello&body=Hi, I would like to connect with you." target="_blank" rel="noopener noreferrer" className="gmail hover:text-red-600 hover:bg-gray-300 duration-200 bg-gray-500 rounded-[0.3vw] md:px-1 md:py-0 md:text-[2vw] text-[6vw] px-[0.5vw] text-black"><FiMail/></a>
                </tbody>
            </div>
            </div>
        </footer>
