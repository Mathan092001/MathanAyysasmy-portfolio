...
export default function Footer() {
    ...
    return(            
        <footer className="footer w-full md:h-[25vh] h-[20vh] bg-black text-gray-300 flex justify-center items-center md:p-8 p-3 select-none">
            ...
            <div className="flex flex-col md:gap-8 gap-4 justify-end items-end text-[6vw] md:text-[2vw] text-gray-500">
                <h1 className='md:text-[2vw] text-[4.5vw]'>Follow:</h1>
                <tbody className='flex gap-2 md:gap-4 items-center '>
                    ...
                    <hr className='border border-blue-800 md:h-[2.5vh] h-[3vw]'/>
                    <a href="mailto:mathanayysamy@gmail.com?subject=Hello&body=Hi, I would like to connect with you." target="_blank" rel="noopener noreferrer" className="gmail hover:text-red-600 hover:bg-gray-300 duration-200 bg-gray-600 rounded-[0.2vw] px-1 text-[2vw] text-black"><FiMail/></a>
                </tbody>
            </div>
            </div>
        </footer>
